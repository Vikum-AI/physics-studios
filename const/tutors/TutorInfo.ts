...
const TutorInfo: ITutorIntro[] = [
  ...
  {
    tutorId: 3,
    tutorName: "Hasaranga Widanagamage",
    description:
      "Mr Hasaranga Widanagamage, a senior Mathematics teacher, a leading international school in Colombo, delivering Edexcel curruculum for over 3,500 students. He is a graduate from the University of Sri Jajewardenepura, Sri Lanka, specialized in Mathematics, Statistics and Computer Sciences. Mr Widanagamage completed his masters degree in Mathematics Education from the University of Colombo. He is also an Associate member of the British Computer Society (AMBCS). ",
    phoneNumber: "+94 714 175 242",
    email: "hasarangawidanagamage@gmail.com",
    image: "/img/hasaranga-pfp.png",
  },
  {
    tutorId: 4,
    tutorName: "Masha Matharage",
    description:
      "Ms Masha Matharage, a Chemistry teacher at a leading international school in Colombo, which is one of the most recognized educational institutions delivering Edexel curriculum for over 3,500 students. She is a graduate from Faculty of Science, University of Colombo, Sri Lanka. Ms Matharage completed her Master of Science in Sustainable Management from University of Bedfordshire.",
    phoneNumber: "+94 710 885 055",
    email: "mashanishadi@gmail.com",
    image: "/img/masha-pfp.png",
  },
];
